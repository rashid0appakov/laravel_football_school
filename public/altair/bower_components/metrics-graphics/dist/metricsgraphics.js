...
MG.data_graphic = function (args) {
  ...
  var defaults = {
    ...
    full_width: false, // sets the graphic width to be the width of the parents element and resizes dynamically
    full_height: false, // sets the graphic width to be the width of the parents element and resizes dynamically
