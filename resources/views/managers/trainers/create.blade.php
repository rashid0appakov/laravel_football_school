...
@section('content')
    ...
    <div id="page_content_inner">
        <form action="/manager/trainers" class="uk-form-stacked" id="trainer_create_form" method="POST" enctype="multipart/form-data">
            @csrf
                                        ...
                                        <div class="uk-margin-top">
                                            ...
                                            <div class="uk-grid" data-uk-grid-margin>
                                                <div class="uk-width-medium-1-2">
                                                    ...
                                                    <input value="{{old('email')}}" class="md-input" type="text" id="email" name="email" required/>
                                                </div>
                                                <div class="uk-width-medium-1-2">
                                                    <label for="user_edit_position_control">Телефон</label>
                                                    <input class="md-input" value="{{old('phone')}}" type="text" id="phone" name="phone" required />
                                                </div>
                                            </div>
