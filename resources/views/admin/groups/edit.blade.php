...
@section('content')
    ...
    <div id="page_content_inner" style="width: 50%">
        <form action="/admin/groups/{{ $group->id }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                            ...
                            <div class="uk-form-row">
                                <div class="uk-grid" data-uk-grid-margin>
                                    <div class="uk-width-medium-1-2" style="margin-top: 20px;">
                                        ...
                                        <input value="{{ old('name', $group->name) }}" name="name" type="text" class="md-input label-fixed" />
                                    </div>
