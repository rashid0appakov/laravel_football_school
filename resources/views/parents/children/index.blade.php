                    ...
                    <div class="uk-width-medium-1-2">
                        <div class="uk-vertical-align">
                            <div class="uk-vertical-align-middle">
                                <a class="md-btn md-btn-primary md-btn-wave-light waves-effect waves-button waves-light" href="/parents/children/create">
                                    Добавить ребенка
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="md-card-head">
                                <div class="md-card-head-menu" data-uk-dropdown="{pos:'bottom-right'}">
                                    ...
                                    <div class="uk-dropdown uk-dropdown-small">
                                        <ul class="uk-nav">
                                            <li><a href="/parents/children/{{ $child->id }}/edit">Редактировать</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="uk-text-center">
                                    <img class="md-card-head-avatar" src="/users/children/avatars/{{ $child->image }}" alt=""/>
                                </div>
                            </div>
                            <div class="md-card-content">
                                <ul class="md-list">
                                    <li>
                                        <div class="md-list-content">
                                            ...
                                            <span class="uk-text-small uk-text-muted">
                                                {{ date('d.m.Y', strtotime($child->birthday)) }}
                                            </span>
                                        </div>
                                    </li>
                                    <li>
