...
class WorkoutsController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        $workout->save();
        return redirect('admin/aboniments/'.$workout->abonement_id.'/edit');
    }
    ...
    public function delete($id)
    {
        ...
        $workout->delete();
        return redirect('/admin/aboniments/'.$abonement_id.'/edit');
    }

    public function destroy(Workout $workout)
    {
        $workout->delete();
        return redirect('/admin/aboniments'.$workout->aboniment_id.'/edit');
    }
}
