...
<div id="page_content_inner">
    <div class="uk-vertical-align-middle">
        <a class="md-btn md-btn-primary md-btn-wave-light waves-effect waves-button waves-light" href="/manager/crm/leads/create">
            Создать заявку
        </a>
    </div>
    ...
    <div style="text-align: center;margin-bottom: 20px;font-size: 20px;">
        <a style="text-decoration: underline;padding: 5px;" href="/manager/crm/leads/">
                ...
                <div class="uk-slider-container">
                    <ul class="uk-slider uk-slider-center uk-grid-width-medium-1-5 uk-grid-width-small-1-2">
                        <li style="padding:10px;">
                            <div class="md-card">
                                <div style="height: 180px;">
                                    <form style="margin-top: 25px;" action="/manager/crm/leads/filter/start-date" method="POST">
                                        @csrf
                        ...
                        <li style="padding:10px;">
                            <div class="md-card">
                                <div style="height: 180px;">
                                    <form style="margin-top: 20px;" action="/manager/crm/leads/filter/status" method="POST">
                                        @csrf
                        ...
                        <li style="padding:10px;">
                            <div class="md-card">
                                <div style="height: 180px;">
                                    <form style="margin-top: 25px;" action="/manager/crm/leads/filter/manager" method="POST">
                                        @csrf
                        ...
                        <li style="padding:10px;">
                            <div class="md-card">
                                <div style="height: 180px;">
                                    <form style="margin-top: 25px;" action="/manager/crm/leads/filter/club" method="POST">
                                        @csrf
...
{{--                            <div class="md-card">--}}
{{--                                <div style="height: 180px;">--}}
{{--                                    <form style="margin-top: 25px;" action="/manager/crm/leads/filter/channel" method="POST">--}}
{{--                                        @csrf--}}
...
{{--                            <div class="md-card">--}}
{{--                                <div style="height: 180px;">--}}
{{--                                    <form style="margin-top: 25px;" action="/manager/crm/leads/filter/entry-point" method="POST">--}}
{{--                                        @csrf--}}
...
{{--                        </li>--}}
                        <li style="padding:10px;">
                            <div class="md-card">
                                <div style="height: 180px;">
                                    <form style="margin-top: 25px;" action="/manager/crm/leads/filter/when" method="POST">
                                        @csrf
                        ...
                        <li style="padding:10px;">
                            <div class="md-card">
                                <div style="height: 180px;">
                                    <form style="margin-top: 25px;" action="/manager/crm/leads/filter/date-range" method="POST">
                                        @csrf
                        ...
                        <li style="padding:10px;">
                            <div class="md-card">
                                <div style="height: 180px;">
                                    <form style="margin-top: 25px;" action="/manager/crm/leads/filter/tasks-date" method="POST">
                                        @csrf
                        ...
                        @foreach($leads as $lead)
                            <tr>
                                ...
                                <td class="uk-text-center">
                                    <a href="/manager/crm/leads/client-create/{{ $lead->id }}"><i style="font-size: 21px;" class="uk-icon-plus-square"></i></a>
                                    <a href="/manager/crm/leads/{{ $lead->id }}/edit"><i class="md-icon material-icons"></i></a>
                                    <a href="/manager/crm/leads/client-delete/{{ $lead->id }}"><i style="font-size: 21px;" class="uk-icon-trash"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
