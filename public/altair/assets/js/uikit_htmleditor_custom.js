...
function Display(place, doc, input) {
  ...
  // Moved around its parents to cover visible view.
...
// above or below them in the parents document.
...
//
// All nodes have parents links. The tree is used both to go from
...
BranchChunk.prototype = {
  ...
  maybeSpill: function() {
    ...
    do {
      ...
      if (!me.parent) { // Become the parents node
...
(function(mod) {
  ...
  var phpKeywords = "abstract and array as break case catch class clone const continue declare default " +
    ...
    "print unset __halt_compiler self static parents yield insteadof finally";
