    ...
    altair_helpers = {
        ...
        content_preloader_show: function(style,variant,container,width,height) {
            ...
            if(!$body.find('.content-preloader').length) {
                var image_density = isHighDensity() ? '' : '',
        ...
        table_tree: function() {
            ...
            $table_tree.each(function() {
                var $this = $(this),
                    ...
                    $this.find('.show_child_row').nextUntil('.table-parents-row').hide();

                    //$(this).parents('tr').nextAll('.table-child-row').show();

                $checkChildrens
                    .on('ifChecked',function() {
                        $(this).closest('tr').addClass('row_checked').nextUntil('.table-parents-row').find('.check_row').iCheck('check');
                    })
                    .on('ifUnchecked',function() {
                        $(this).closest('tr').removeClass('row_checked').nextUntil('.table-parents-row').find('.check_row').iCheck('uncheck');
                    });
                ...
                $toggleChildrens.on('click', function(e) {
                    e.preventDefault();
                    $(this).closest('tr').toggleClass('show_child_row').nextUntil('.table-parents-row').toggle();
                });
