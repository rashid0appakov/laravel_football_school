    ...
    <div id="page_content_inner" style="padding-bottom: 10px;">
        <div class="uk-grid" data-uk-grid-margin data-uk-grid-match id="user_profile">
                ...
                <div class="md-card">
                    <div class="user_heading">
                        <div class="user_heading_avatar">
                            <div class="thumbnail">
                                <img src="/users/trainers/avatars/{{ $trainer->image }}" alt="user avatar"/>
                            </div>
                        </div>
                                ...
                                <ul class="md-list">
                                    @if(count($tasks) > 0)
                                        @foreach($tasks as $task)
                                            <li>
                                                <div class="md-list-content">
                                                    <span class="md-list-heading"><a href="/admin/trainer/task/{{ $task->id }}">{{ $task->title }}.</a></span>
            ...
            <div class="uk-width-large-3-10 hidden-print">
                ...
                <div >
                    <a style="margin-top: 20px;margin-left: 47px;" class="md-btn md-btn-primary md-btn-wave-light waves-effect waves-button waves-light" href="/admin/manager/create-task/{{ $trainer->id }}">
                        Добавить задачу
                    </a>
                </div>
            </div>
