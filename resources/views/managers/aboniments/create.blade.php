...
@section('content')
    ...
    <div id="page_content_inner" style="width: 50%">
        <form action="/manager/aboniments" method="POST" enctype="multipart/form-data">
        @csrf
            <div class="md-card">
            ...
            <div class="md-card">
                <div class="md-card-content" style="text-align: center;">
                    ...
                    <a style="float:right" href="/manager/aboniments" class="md-btn md-btn-primary md-btn-wave-light waves-effect waves-button waves-light">
                        Назад
                    </a>
                </div>
            </div>
