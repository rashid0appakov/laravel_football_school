        ...
        <div class="md-card uk-margin-medium-bottom">
            <div class="md-card-content">
                <div class="uk-grid" data-uk-grid-margin>
                    <div class="uk-width-medium-1-2">
                        <div class="uk-vertical-align">
                            <div class="uk-vertical-align-middle">
                                <a class="md-btn md-btn-primary md-btn-wave-light waves-effect waves-button waves-light" href="/admin/trainers/create">
                                    Добавить тренера
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="uk-width-medium-1-2">
                        <label for="contact_list_search">Поиске... (мин 3 символа.)</label>
                            ...
                            <div class="md-card-head">
                                <div class="md-card-head-menu" data-uk-dropdown="{pos:'bottom-right'}">
                                    ...
                                    <div class="uk-dropdown uk-dropdown-small">
                                        <ul class="uk-nav">
                                            <li><a href="/admin/trainers/{{ $trainer->id }}/edit">Редактировать</a></li>
                                            <li><a href="/admin/trainers/{{ $trainer->id }}">Просмотр</a></li>
                                            <li><a href="/admin/trainers/delete-trainers/{{ $trainer->id }}">Удалить</a></li>
                                        </ul>
                                    </div>
                                </div>
