...
@section('content')
    ...
    <div id="page_content_inner" style="">
        ...
        <form action="/manager/aboniments/{{ $aboniment->id }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method("PUT")
                ...
                <div class="md-card-content">
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        ...
                        <div class="md-card-content" style="text-align: center;width: 100%;">
                            ...
                            <a style="float:right;margin-right: 13px;" href="/manager/aboniments" class="md-btn md-btn-primary md-btn-wave-light waves-effect waves-button waves-light">
                                Назад
                            </a>
                        </div>
                    </div>
            ...
            <div class="uk-width-medium-1-2">
                ...
                @if(count($workouts) > 0)
                    ...
                    @foreach($workouts as $workout)
                        <form action="/manager/workouts/{{ $workout->id }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method("PUT")
                            <input type="hidden" name="aboniment_id" value="{{ $aboniment->id }}">
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-1-1">
                                            <div class="uk-form-row">
                                                ...
                                                <a href="/manager/workouts/delete/{{ $workout->id }}" style="margin-top: 10px;" class="md-btn md-btn-danger md-btn-wave-light waves-effect waves-button waves-light">
                                                    Удаить
                                                </a>
                                            </div>
                                        </div>
                ...
                <form action="/manager/workouts" method="POST" enctype="multipart/form-data">
                    @csrf
