                ...
                <div class="md-card">
                    ...
                    <div class="md-card-content">
                        <div class="uk-margin-bottom uk-text-center">
                            <img src="/altair/assets/img/ecommerce/s6_edge.jpg" alt="" class="img_medium" />
                        </div>
                        <ul class="uk-grid uk-grid-width-small-1-3 uk-text-center" data-uk-grid-margin>
                            <li>
                                <img src="/altair/assets/img/ecommerce/s6_edge_1.jpg" alt="" class="img_small"/>
                            </li>
                            <li>
                                <img src="/altair/assets/img/ecommerce/s6_edge_2.jpg" alt="" class="img_small"/>
                            </li>
                            <li>
                                <img src="/altair/assets/img/ecommerce/s6_edge_3.jpg" alt="" class="img_small"/>
                            </li>
                        </ul>
                    </div>
                </div>
