...
@section('content')
    ...
    <div id="page_content_inner">
        <form action="/manager/areas" method="POST" enctype="multipart/form-data">
        @csrf
            <div class="md-card">
                                ...
                                <div class="uk-width-medium-1-1">
                                    <div class="uk-form-row">
                                        <div class="uk-grid" data-uk-grid-margin>
                                            <div class="uk-width-medium-1-2">
                                                ...
                                                <input value="{{ old('admin') }}" name="admin" type="text" class="md-input label-fixed" />
                                            </div>
                                            <div class="uk-width-medium-1-2">
                                                <label>E-mail</label>
                                    ...
                                    <div class="uk-form-row">
                                        <div class="uk-grid" data-uk-grid-margin>
                                            <div class="uk-width-medium-1-2">
                                                <label>Телефон</label>
                                                <input value="{{ old('phone') }}" name="phone" type="text" class="md-input label-fixed" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
