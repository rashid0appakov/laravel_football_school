...
<div id="page_content_inner">
    <div class="uk-vertical-align-middle">
        <a class="md-btn md-btn-primary md-btn-wave-light waves-effect waves-button waves-light" href="/admin/crm/clients/create">
            Создать клиента
        </a>
    </div>
    ...
    <div class="uk-form-row">
        <div class="uk-grid" data-uk-grid-margin>
            <div class="uk-width-medium-1-5" style="margin-bottom: 20px;">
                <form action="/admin/crm/client/filter/type" method="POST">
                    @csrf
                    <label>Тип</label>
            ...
            <div class="uk-width-medium-1-5" style="margin-bottom: 20px;">
                <form action="/admin/crm/clients/filter/start-date" method="POST">
                    @csrf
            ...
            <div class="uk-width-medium-1-5" style="margin-bottom: 20px;">
                <form action="/admin/crm/clients/filter/entry-point-client" method="POST">
                    @csrf
            ...
            <div class="uk-width-medium-1-5" style="margin-bottom: 20px;">
                <form action="/admin/crm/leads/filter/child-exist" method="POST">
                    @csrf
            ...
            <div class="uk-width-medium-1-5" style="margin-bottom: 20px;">
                <form action="/admin/crm/leads/filter/workout-balance" method="POST">
                    @csrf
            ...
            <div class="uk-overflow-container">
                <table class="uk-table uk-table-striped uk-table-hover">
                    ...
                    <tr>
                        ...
                        <th>Имя</th>
                        <th>Телефон</th>
                        <th>Данные из ссылки</th>
                        <th>Действия</th>
                    </tr>
                    </thead>
                    <tbody>
                        @foreach($clients as $client)
                            <tr style="background: {{ $client->status->color }}">
                                ...
                                <td class="uk-text-center">
                                    <a href="/admin/crm/clients/{{ $client->id }}/edit"><i class="md-icon material-icons"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
