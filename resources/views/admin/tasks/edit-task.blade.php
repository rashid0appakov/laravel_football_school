...
@section('content')
    ...
    <div id="page_content_inner">
        <form action="/admin/manager/update-task" class="uk-form-stacked" id="manager_create_form" method="POST" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="md-card">
                        ...
                        <div class="user_content">
                            ...
                            <ul id="user_edit_tabs" class="uk-tab" data-uk-tab="{connect:'#user_edit_tabs_content'}">
                                <li class="uk-active"><a href="#">Редактирование задачи</a></li>
                            </ul>
                                    ...
                                    <div class="uk-margin-top">
                                        <div class="uk-grid" data-uk-grid-margin>
                                            <div class="uk-width-medium-1-2">
                                                ...
                                                <input value="{{old('title', $task->title)}}" class="md-input" type="text" id="title" name="title" required/>
                                            </div>
                                            <div class="uk-width-medium-1-2">
                                                <label for="user_edit_position_control">Дедлайн</label>
                                                <input class="md-input" value="{{old('deadline', $task->deadline)}}" type="text" id="deadline" name="deadline" required />
                                            </div>
                                        </div>
                                        <div class="uk-grid">
                                        ...
                                        <div class="uk-grid" data-uk-grid-margin>
                                            <div class="uk-width-medium-1-2">
                                                ...
                                                <select data-md-selectize name="status_id">
                                                    ...
                                                    @if($task->status != null)
                                                        <option selected value="{{ $task->status->id }}">{{ $task->status->name }}</option>
                                                    @endif
