        ...
        <div class="uk-width-large-1-3">
            <div class="md-card">
                <div class="md-card-content">
                    ...
                    <form action="{{route('manager.trainings.update', $training->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                    ...
                    <form action="{{route('manager.trainings.destroy', $training->id)}}" class="confirmed" method="post">
                        @csrf
                        @method('delete')
        ...
        <div class="uk-width-large-1-3">
            <div class="md-card">
                <div class="md-card-content">
                    ...
                    <form action="{{route('manager.trainings.checkUsers', $training->id)}}" class="confirmed" data-text="Будте внимательны, изменить эти данные повторно нельзя">
                        ...
                        <ul class="md-list md-list-addon uk-margin-bottom">
                            ...
                            <li>
                                ...
                                <a href="{{route('manager.leads.edit', $item->lead->id)}}" class="md-list-content">
                                    <span class="md-list-heading">{{$item->name}}</span>
            ...
            <div class="md-card">
                <div class="md-card-content">
                    ...
                    <ul class="md-list">
                        ...
                        <li>
                            <a href="{{route('manager.trainings.edit', $item->id)}}" class="md-list-content">
