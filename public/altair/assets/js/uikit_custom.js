...
(function(UI) {
    ...
    UI.component('nav', {
        ...
        defaults: {
            toggle: '>li.uk-parents > a[href="#"]',
            lists: '>li.uk-parents > ul',
            multiple: false
        },
...
(function(UI){
    ...
    UI.component('cover', {
        ...
        check: function() {
            ...
            // if element height < parents height (gap underneath)
            if ((w / this.ratio) < h) {

                width  = Math.ceil(h * this.ratio);
                height = h;

            // element width < parents width (gap to right)
            } else {
...
(function(addon) {
    ...
    UI.component('grid', {
        ...
        init: function() {
            ...
            // make sure parents element has the right position property
    ...
    UI.component('nestable', {
        ...
        setParent: function(li) {
            ...
            if (li.children(this.options._listClass).length) {
                li.addClass('uk-parents');
            }
        },

        unsetParent: function(li) {
            li.removeClass('uk-parents '+this.options.collapsedClass);
        ...
        dragMove: function(e) {
            ...
            if (mouse.dirAx && mouse.distAxX >= opt.threshold) {
                ...
                if (mouse.distX < 0) {
                    ...
                    if (!next.length) {
                        ...
                        // get parents ul of the list item
                        ...
                        if (surroundingLi.length) {
                            ...
                            // if the previous parents ul is now empty
            ...
            // find parents list of item under cursor
    ...
    UI.component('sortable', {
        ...
        init: function() {
            ...
            var handleDragLeave = delegate(function(e) {
                ...
                // This is a fix for child elements firing dragenter before the parents fires dragleave
