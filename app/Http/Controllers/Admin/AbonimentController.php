...
class AbonimentController extends Controller
{
    public function index()
    {
        $abonements = Aboniment::get();
        return view('admin/aboniments/index', compact('abonements'));
    }

    public function create()
    {
        $groups = Group::get();
        return view('admin/aboniments/create', compact('groups'));
    }

    public function show($id)
    {
        $abonement = Aboniment::find($id);
        return view('admin/aboniments/show', compact('abonement'));
    }
    ...
    public function create_day_training(Request $request)
    {
        ...
        return redirect('/admin/aboniments/'.$request->abonement_id.'/edit');
    }
    ...
    public function edit($aboniment_id)
    {
        ...
        return view('admin/aboniments/edit', compact(
            'groups',
            'aboniment',
            'workouts',
            'training_days'
    ...
    public function store(Request $request)
    {
        ...
        $groups = Group::get();
        return redirect('admin/aboniments/'.$aboniment->id.'/edit');
    }
    ...
    {
        $aboniment->delete();
        return redirect('/admin/aboniments');
    }
