            ...
            <div class="uk-width-medium-1-1" style="margin-top: 20px;">
                ...
                <div class="md-card expandable" style="margin-top: 20px;display: none"  id="form">
                    <div class="md-card-content">
                        ...
                        <form action="/manager/tasks/trainer/trainerTaskStore" method="POST">
                            @csrf
                ...
                <div style="text-align: center;margin-bottom: 20px;font-size: 20px;">
                    <a style="text-decoration: underline;padding: 5px;" href="/manager/tasks/trainer/">
                        ...
                        <div class="uk-form-row">
                            <div class="uk-grid" data-uk-grid-margin>
                                <div class="uk-width-medium-1-5" style="margin-bottom: 20px;">
                                    <form action="/manager/tasks/trainer/filter-date-range" method="POST">
                                        @csrf
                                ...
                                <div class="uk-width-medium-1-5" style="margin-bottom: 20px;">
                                    <form action="/manager/tasks/trainer/club" method="POST">
                                        @csrf
                                        <label>Клуб</label>
                                ...
                                <div class="uk-width-medium-1-5" style="margin-bottom: 20px;">
                                    <form action="/manager/tasks/trainer/tag" method="POST">
                                        @csrf
                                        <label>Тег</label>
                                ...
                                <div class="uk-width-medium-1-5" style="margin-bottom: 20px;">
                                    <form action="/manager/tasks/trainer/filter-when" method="POST">
                                        @csrf
                                        <label>Когда</label>
                ...
                <div class="modal js-modal" data-modal="return" >
                    ...
                    <div class="md-card-content">
                        <h3 class="heading_a">Новая задача</h3>
                        <form id="form" action="/manager/tasks/trainer/trainerTaskStore" method="POST">
                            @csrf
                            <div class="uk-grid" data-uk-grid-margin>
                                <div class="uk-width-medium-1-1">
                                    {{--                                    <div class="uk-form-row" style="margin-top: 20px;">--}}
                ...
                @if(count($tasks) > 0)
                    ...
                    @foreach($tasks as $task)
                        ...
                        <div class="modal js-modal" tabindex="-1" data-modal="formpdate" aria-hidden="true">
                            ...
                            <div class="md-card-content">
                                <form action="/manager/tasks/trainer/trainerTaskUpdate" method="POST">
                                    @csrf
