...
@section('content')
    ...
    <div id="page_content_inner" style="padding-bottom: 10px;">
        ...
        <form action="/admin/clubs/{{ $club->id }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method("PUT")
...
{{--                                <input type="file" id="input-file-b" name="image" class="dropify"  data-default-file="/clubs/{{ $club->image }}"/>--}}
            ...
            <div class="md-card">
                <div class="md-card-content" style="text-align: center;">
                    ...
                    <a style="float: right" href="/admin/clubs" class="md-btn md-btn-primary md-btn-wave-light waves-effect waves-button waves-light">
                        Список клубов
                    </a>
                </div>
            </div>
    ...
    <div id="page_content_inner">
        ...
        <div class="uk-vertical-align-middle" style="display: flex;">
            <a class="md-btn md-btn-primary md-btn-wave-light waves-effect waves-button waves-light" href="/admin/warehouses/create/{{ $club->id }}">
                Добавить инвентарь
            </a>
                            ...
                            @foreach($warehouses as $warehouse)
                                <tr>
                                    ...
                                    <td class="uk-text-center">
                                        <a href="/admin/warehouses/edit/{{ $warehouse->id }}"><i class="md-icon material-icons"></i></a>
                                        <a href="javascript:void(0);" onclick="return submit_form_warehouse({{ $i }})">
                                            <i class="md-icon material-icons"></i>
                                        </a>
                                        <form action="/admin/warehouses/delete" method="POST" id="delete_warehouse_{{ $i }}">
                                            @csrf
