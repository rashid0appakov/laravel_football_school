                    ...
                    <div class="md-card-content">
                        ...
                        <div class="uk-grid" data-uk-grid-margin>
                            <div class="uk-width-medium-1-1">
                                <form action="/admin/crm/leads/{{ $lead->id }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="uk-form-row">
                                        ...
                                        <hr style="margin-top: 25px;">
                                        <p>
                                            Создал Администратор || {{ $lead->created_at }}
                                        </p>
                                    </div>
            ...
            <div class="uk-width-1-2">
                ...
                <div class="md-card">
                    <div class="md-card-content">
                        ...
                        @endif
                        <form action="{{route('admin.lead_comment.store', $lead->id)}}" method="post">
                            @csrf
                            <input type="hidden" name="lead_id" value="{{$lead->id}}">
                            <div class="uk-form-row">
                ...
                @if(count($tasks) > 0)
                    ...
                    @foreach($tasks as $task)
                        ...
                        <div class="md-card expandable" style="margin-top: 20px;display: none;"  id="task_form_edit{{$i}}">
                            <div class="md-card-content">
                                <form id="formUpdate" action="/admin/tasks/my/myTaskUpdate" method="POST">
                                    @csrf
    ...
    <script>
        window.onload = function(){
            $('#group').change(function(){
                ...
                $.get('/admin/groups/' + group_id + '/trainings')
