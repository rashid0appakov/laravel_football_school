            ...
            <div class="uk-width-medium-1-1" style="margin-top: 20px;">
                ...
                <div class="md-card expandable" style="margin-top: 20px;display: none"  id="form">
                    <div class="md-card-content">
                        ...
                        <form action="/admin/tasks/manager/managerTaskStore" method="POST">
                            @csrf
                ...
                <div style="text-align: center;margin-bottom: 20px;font-size: 20px;">
                    <a style="text-decoration: underline;padding: 5px;" href="/admin/tasks/manager">
                        ...
                        <div class="uk-form-row">
                            <div class="uk-grid" data-uk-grid-margin>
                                <div class="uk-width-medium-1-5" style="margin-bottom: 20px;">
                                    <form action="/admin/tasks/manager/filter-date-range" method="POST">
                                        @csrf
                                ...
                                <div class="uk-width-medium-1-5" style="margin-bottom: 20px;">
                                    <form action="/admin/tasks/manager/club" method="POST">
                                        @csrf
                                        <label>Клуб</label>
                                ...
                                <div class="uk-width-medium-1-5" style="margin-bottom: 20px;">
                                    <form action="/admin/tasks/manager/tag" method="POST">
                                        @csrf
                                        <label>Тег</label>
                                ...
                                <div class="uk-width-medium-1-5" style="margin-bottom: 20px;">
                                    <form action="/admin/tasks/manager/filter-when" method="POST">
                                        @csrf
                                        <label>Когда</label>
